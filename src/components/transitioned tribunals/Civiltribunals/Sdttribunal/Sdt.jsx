...
import image from '../../../../imagestwo/kenyansporttwo.jpg'
  ...
  return (
    ...
    <section className="jurisdiction_plans">
        <div className='jurisdiction_container-left_box'>
            ...
            <h3>Hon. Murunga Benard Wafula Munyefu
</h3>
            <h2 className='tribenamess'>Current Members</h2>
                    ...
                    <Link className='link-teams-color' to="https://bit.ly/3uxb3DO"   target="_blank"> https://bit.ly/3uxb3DO </Link> 
                    <h2>Contact</h2>
        ...
        <div className="jurisdiction_container-right_box">
            ...
            <h2>Jurisdiction</h2>
                ...
                <Link className="button-link" to="https://sites.google.com/view/sportstribunaldecisions?usp=sharing"   target="_blank"> Click to See The Judgments </Link> 
                </div>
                <h2>Location</h2>
