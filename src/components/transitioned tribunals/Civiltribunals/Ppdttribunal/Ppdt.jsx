...
import image from '../../../../imagestwo/parliamentkenya.jpg'
import qrcode from '../../../../imagestwo/ppdtqrcode.jpeg'
    ...
    <section className="jurisdiction_plans">
        <div className='jurisdiction_container-left_box'>
            ...
            <h2 className='tribenamess'>Current Members</h2>
                    ...
                    <Link className='link-teams-color' to="https://shorturl.at/uHJN5"   target="_blank"> https://shorturl.at/uHJN5 </Link> 
                    <h2>Contact</h2>
        ...
        <div className="jurisdiction_container-right_box">
            ...
            <h3>It is composed of; a Chairperson, six other persons, 3 (three) of whom shall be Advocates of the High Court of Kenya of seven years standing and 3 (three) other professionals with outstanding governance, administrative, social, political, economic and other record; a Vice-Chairperson shall be appointed from among the three advocates as stated above.</h3>
            ...
            <h2>Jurisdiction</h2>
                ...
                <Link className="button-link" to="https://sites.google.com/view/politicalpartiesdispute/home"   target="_blank"> Click to See The Judgments </Link> 
                </div>
                <h2>Location</h2>
